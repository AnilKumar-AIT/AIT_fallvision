...
export default function SleepDiaryPage({ residentId, showBackButton, onBackToResident }) {
  ...
  useEffect(() => { loadSleepData(); }, [activeResidentId]);
                                                    ...
                                                    if (loading) {
    return (
      <main style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", paddingTop: 90, minHeight: "100vh" }}>
        {showBackButton && onBackToResident && (
          <button
            ...
            style={{
              ...
              borderRadius: 12, padding: "12px 20px", color: "#ffffff",
