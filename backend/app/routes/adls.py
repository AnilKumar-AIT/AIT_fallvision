...
async def get_adls_data(resident_id: str) -> Dict:
    ...
    try:
        ...
        try:
            ...
            logger.error(f"Failed to fetch hourly ADL data for {resident_id}: {e}")
            hourly_records = []
        ...
        try:
            ...
            logger.error(f"Failed to fetch daily ADL summary for {resident_id}: {e}")
            daily_summary = {}
        ...
        for record in hourly_records:
            try:
                ...
                logger.warning(f"Skipping malformed hourly record for {resident_id}: {e}")
                continue
        ...
        print(f"  Sit:   {total_sit_minutes} minutes")
        print(f"  Walk:  {total_walk_minutes} minutes")
        print(f"  Stand: {total_stand_minutes} minutes")
